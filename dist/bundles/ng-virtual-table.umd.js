         ...
         */
            function (changes) {
                ...
                if ('dataSource' in changes) {
                    ...
                    this._dataStream = rxjs.combineLatest(this.sort$.asObservable().pipe(operators.startWith(null)), rxjs.combineLatest(newDataSource.pipe(operators.map(function (stream, index) { return stream.map(function (e) { return (__assign({}, e, { $$$id: index })); }); }), operators.tap(function (stream) {
